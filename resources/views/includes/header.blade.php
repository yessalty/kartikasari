<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        ...
        <a href="{{ asset('dashboard')}}" class="logo text-white fw-bold">
            <img src="{{ asset('storage/logo/logo.jpeg') }}" style="width: 40px; border-radius:50%" alt="navbar brand" class="navbar-brand"> Kartikasari
        </a>
